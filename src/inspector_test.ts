...
test(async function inspector_describe() {
  ...
  // Simple primitives.
  t(12.34, [{ type: "number", value: "12.34" }]);
  t("abcd", [{ type: "string", value: "abcd" }]);
  t(false, [{ type: "boolean", value: "false" }]);
  t(true, [{ type: "boolean", value: "true" }]);
  t(null, [{ type: "null" }]);
  t(undefined, [{ type: "undefined" }]);
  t(Symbol(), [{ type: "symbol", value: "Symbol()" }]);
  ...
  t(new Date(sometime), [
    {
      type: "box",
      primitive: { type: "date", value: sometime },
      ctor: "Date",
      props: []
    }
  ]);
  t(/acme/gi, [
    {
      type: "box",
      primitive: { type: "regexp", value: "/acme/gi" },
      ctor: "RegExp",
      props: []
    }
  ]);
  ...
  t(new String("hello world"), [
    {
      type: "box",
      primitive: { type: "string", value: "hello world" },
      ctor: "String",
      props: []
    }
  ]);
  // Object without prototype.
  t(Object.create(null), [{ type: "object", ctor: null, props: [] }]);
  ...
  t(new MyNumber(11), [
    {
      type: "box",
      primitive: { type: "number", value: "11" },
      ctor: "MyNumber",
      props: []
    }
  ]);
  ...
  t(new MyString("hello mars"), [
    {
      type: "box",
      primitive: { type: "string", value: "hello mars" },
      ctor: "MyString",
      props: []
    }
  ]);
