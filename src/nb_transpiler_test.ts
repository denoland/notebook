...
test(function nb_transpiler_transpile() {
  ...
  t("import 'module-name';", "return (await __import('module-name'));");
  t("var x = y;", "void ((__global.x = y));");
  t("const x = y;", "void ((__global.x = y));");
  t("let x = y;", "void ((__global.x = y));");
  t(
    "let a, b, c, d;",
  ...
  t("var [d, e] = [2, 3];", "void (([__global.d, __global.e] = [2, 3]));");
  t("var [[e], [[f]]] = [];", "void (([[__global.e], [[__global.f]]] = []));");
  t("0", "return (0)");
  t("({ a: b.c } = {});", "return (({ a: b.c } = {}));");
  t("[a, b] = [c, d];", "return ([a, b] = [c, d]);");
  t("a = 3;", "return (a = 3);");
  t(
...
test(async function nb_transpiler_formatException() {
  ...
  t("\n" + "import * as foo from 'bar';badfn()", "test3", "test3:2:28");
  t(
    "function wierd() {\n" + "  return badfn();\n" + "} 1+2+3+wierd()",
    "test4",
    "test4:2:3",
...
test(async function nb_transpiler_getEntryPoint() {
  ...
  t("checkEntryPoint(getEntryPoint(), 'file1')", "file1");
  t(
    "function elsewhere() { return getEntryPoint() }\n" +
